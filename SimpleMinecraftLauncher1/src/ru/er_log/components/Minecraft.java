...
public class Minecraft {
    ...
    public static void checkMinecraft() throws IOException{
    ...
    public static void md5(String s) throws MalformedURLException, IOException{
        URLConnection conn = new URL("http://simpleminecraft.ru/newauth/scripts/gb_checkminecraft.php?md5=" + s).openConnection();
        ...
        if (!html.equalsIgnoreCase("0")){
            JOptionPane.showMessageDialog(null, "Ошибка безопасности", "SimpleMinecraft.Ru | Guard", JOptionPane.ERROR_MESSAGE, null);
            Runtime.getRuntime().exit(1);   
        }
    }
