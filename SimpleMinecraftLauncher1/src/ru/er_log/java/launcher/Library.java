...
public class Library {
    ...
    public String getArtifactPath()
    {
        ...
        {
            getArtifactBaseDir(), getArtifactFilename()
        });
    }
    ...
    public String getArtifactPath(String classifier)
    {
        ...
        return String.format("%s/%s", new Object[]
        {
            getArtifactBaseDir(), getArtifactFilename(classifier)
        });
    }
    ...
    public String getArtifactFilename()
    {
        ...
        String[] parts = this.name.split(":", 3);
        return String.format("%s-%s.jar", new Object[]
        {
            parts[1], parts[2]
        });
    }
    ...
    public String getArtifactFilename(String classifier)
    {
        if (this.name == null)
            throw new IllegalStateException("Cannot get artifact filename of empty/blank artifact");
        String[] parts = this.name.split(":", 3);
        return String.format("%s-%s-%s.jar", new Object[]
        {
            parts[1], parts[2], classifier
        });
    }

    public String toString()
    {
        return "Library{name='" + this.name + '\'' + ", rules=null" + ", natives=" + this.natives + ", extract=null" + '}';
    }
